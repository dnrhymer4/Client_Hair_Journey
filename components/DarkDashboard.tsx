...
const socials = [
  { platform: "Instagram", handle: "@locsbystephb", url: "instagram.com/locsbystephb", icon: Globe, posts: 18, views: "12.4K" },
  { platform: "Facebook", handle: "Locs by Steph B", url: "facebook.com/locsbystephb", icon: Globe2, posts: 9, views: "4.8K" },
